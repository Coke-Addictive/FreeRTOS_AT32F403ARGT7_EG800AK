...
/* Private defines -------------------------------------------------------------*/
#define Eg_Launch_PIN    GPIO_PINS_5
#define Eg_Launch_GPIO_PORT    GPIOC
#define Eg_DTR_PIN    GPIO_PINS_0
#define Eg_DTR_GPIO_PORT    GPIOB
#define Eg_Power_PIN    GPIO_PINS_2
#define Eg_Power_GPIO_PORT    GPIOB
#define USART3_TX_Eg_PIN    GPIO_PINS_10
#define USART3_TX_Eg_GPIO_PORT    GPIOB
#define USART3_RX_Eg_PIN    GPIO_PINS_11
#define USART3_RX_Eg_GPIO_PORT    GPIOB
